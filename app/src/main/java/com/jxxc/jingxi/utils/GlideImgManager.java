...
public class GlideImgManager {
    ...
    private static int noImg = R.mipmap.jingxi_logo;
//    private static int noImg = R.drawable.loading_large;
    ...
    public static void loadGifImage(Context context, String url, ImageView iv) {
        Glide.with(context).load(url).asGif().diskCacheStrategy(DiskCacheStrategy.RESULT).placeholder(noImg).error(R.mipmap.jingxi_logo).into(iv);
    }
