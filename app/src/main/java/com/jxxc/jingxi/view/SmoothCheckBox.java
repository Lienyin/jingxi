...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED = Color.parseColor("#00BFA5");
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, AppUtils.dp2px(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = AppUtils.dp2px(getContext(), DEF_DRAW_SIZE);
